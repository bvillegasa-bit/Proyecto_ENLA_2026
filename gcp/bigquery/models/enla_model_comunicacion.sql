-- BigQuery ML Logistic Regression Model: Comunicacion
--
-- Trains a model to predict ENLA 2026 success/failure for Comunicacion area.
...
CREATE OR REPLACE MODEL `{project_id}.{dataset_id}.enla_model_comunicacion_v1`
OPTIONS(
