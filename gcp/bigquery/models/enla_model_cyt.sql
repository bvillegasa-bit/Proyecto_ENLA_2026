-- BigQuery ML Logistic Regression Model: CYT (Ciencia y Tecnologia)
--
-- Trains a model to predict ENLA 2026 success/failure for CYT area.
...
CREATE OR REPLACE MODEL `{project_id}.{dataset_id}.enla_model_cyt_v1`
OPTIONS(
