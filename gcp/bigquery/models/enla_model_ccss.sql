-- BigQuery ML Logistic Regression Model: CCSS (Ciencias Sociales)
--
-- Trains a model to predict ENLA 2026 success/failure for CCSS area.
...
CREATE OR REPLACE MODEL `{project_id}.{dataset_id}.enla_model_ccss_v1`
OPTIONS(
